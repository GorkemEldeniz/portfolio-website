	...
	return (
		<div className='flex flex-col gap-10 px-[3.75rem] py-[1.5rem] font-light text-center'>
			...
			<div className='flex justify-center'>
				<span className='h-[1px] w-[20rem] bg-foreground'></span>
			</div>
			...
			<div className='flex justify-center gap-6'>
				<Button className='text-2xl font-light' size='lg' variant='outline'>
					Projects
				</Button>
				<Button className='text-2xl font-light' size='lg'>
					Contact
				</Button>
			</div>
		</div>
